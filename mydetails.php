...
?>
<?php 
$result = retrive_userdeatils($_SESSION['user_data'][0]['user_id'],$conn);
$no_of_post = no_of_post($_SESSION['user_data'][0]['user_id'],$conn);
$following = following($_SESSION['user_data'][0]['user_id'],$conn);
$followers = followers($_SESSION['user_data'][0]['user_id'],$conn);
if(isset($result)){ 
?>
    ...
    <div class="container">
        ...
        <div class="card h-100">
            <div class="card-body mycard">
                <div class="profile-pic-div" style="background-image: url(profile/<?php echo $result[0]['profile_img']; ?>);">
                    <!-- profile image -->
                </div>
                <br>
