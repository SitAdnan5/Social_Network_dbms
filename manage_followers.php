...
$result = follower_friends_details($_SESSION['user_data'][0]['user_id'],$conn);
// print_r($result);
?>
<?php
include('menu.php');
       ...
       <?php foreach($result as $friends){ ?>
         <div style="padding:6px;" class="user-details">
            <div class="inner-details">
               ...
               <button class="follow"><a href="manage_followers_result.php?user_id=<?php echo $friends['user_id'];?>">View</a></button>
            </div>
         </div>
         <br><br>
        <?php }?>
